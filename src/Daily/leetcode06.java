...
public class leetcode06 {
    ...
    public static int compareVersion(String version1, String version2) {
        ...
        int len=split.length < split1.length ? split.length:split1.length;
        int longLen=split.length < split1.length ? split1.length:split.length;
        for (int i = 0; i <len ; i++) {
        ...
        String [] temp=split.length < split1.length ? split1:split;
